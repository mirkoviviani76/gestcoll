...
/**
 * @file
 * @brief Generated from links.xsd.
 */

#ifndef XML_SCHEMA_LINKS_HXX
#define XML_SCHEMA_LINKS_HXX
...
{
  /**
   * @brief C++ namespace for the %http://gestColl/links
   * schema namespace.
   */
  namespace links
  {
    ...
    class link: public ::xml_schema::type
    {
       ...
       * @brief Element traits type.
       */
      typedef ::xsd::cxx::tree::traits< url_type, wchar_t > url_traits;
    ...
    /**
     * @brief Class corresponding to the %linklist schema type.
     *
     * @nosubgrouping
     */
    class linklist: public ::xml_schema::type
    {
      public:
      /**
       * @name link
       ...
       * @brief Element type.
       */
      typedef ::gestColl::links::link link_type;
    ...
    /**
     * @brief Class corresponding to the %links schema type.
     *
     * @nosubgrouping
     */
    class links: public ::xml_schema::type
    {
       ...
       * @name categoria
       *
       * @brief Accessor and modifier functions for the %categoria
       * sequence element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::gestColl::links::linklist categoria_type;

      /**
       * @brief Element sequence container type.
       */
      typedef ::xsd::cxx::tree::sequence< categoria_type > categoria_sequence;

      /**
       * @brief Element iterator type.
       */
      typedef categoria_sequence::iterator categoria_iterator;

      /**
       * @brief Element constant iterator type.
       */
      typedef categoria_sequence::const_iterator categoria_const_iterator;

      /**
       * @brief Element traits type.
       */
      typedef ::xsd::cxx::tree::traits< categoria_type, wchar_t > categoria_traits;
...
namespace gestColl
{
  ...
  {
    /**
     * @name Parsing functions for the %links document root.
     *
     * Descrizione di un elenco di link
     */
    //@{
...
namespace gestColl
{
  namespace links
  {
    ...
    void
    operator<< (::xercesc::DOMElement&, const linklist&);

    /**
     * @name Serialization functions for the %links document root.
     *
     * Descrizione di un elenco di link
     */
    //@{
     ...
     */
    void
    links_ (::std::ostream& os,
            const ::gestColl::links::links& x, 
     ...
     */
    void
    links_ (::xercesc::XMLFormatTarget& ft,
            const ::gestColl::links::links& x, 
            const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
            const ::std::wstring& e = L"UTF-8",
            ::xml_schema::flags f = 0);
    ...
    links_ (const ::gestColl::links::links& x, 
            const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
            ::xml_schema::flags f = 0);
