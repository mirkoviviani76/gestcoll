...
namespace gestColl
{
  namespace contenitori
  {
    ...
    : ::xml_schema::type (),
      righe_ (righe, this),
      colonne_ (colonne, this),
      dimensione_ (dimensione, this),
      id_ (id, this)
    {
    }
    ...
    operator= (const vassoio& x)
    {
      if (this != &x)
      {
        ...
        this->righe_ = x.righe_;
        this->colonne_ = x.colonne_;
        this->dimensione_ = x.dimensione_;
        this->id_ = x.id_;
      }
...
namespace gestColl
{
  namespace contenitori
  {
                  ...
                  const ::xml_schema::properties& p)
    {
      ...
      return ::std::auto_ptr< ::gestColl::contenitori::contenitori > (
    ...
    ::std::auto_ptr< ::gestColl::contenitori::contenitori >
    contenitori_ (const ::xercesc::DOMDocument& doc,
                  ::xml_schema::flags f,
                  const ::xml_schema::properties& p)
    {
