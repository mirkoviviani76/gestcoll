...
namespace gestColl
{
  namespace coins
  {
    ...
    const moneta::autorita_type& moneta::
    autorita () const
    {
      return this->autorita_.get ();
    }

    moneta::autorita_type& moneta::
    autorita ()
    {
      return this->autorita_.get ();
    }
    ...
    const moneta::note_type& moneta::
    note () const
    {
      return this->note_.get ();
    }

    moneta::note_type& moneta::
    note ()
    {
      return this->note_.get ();
    }
...
namespace gestColl
{
  namespace coins
  {
    ...
    : ::xml_schema::type (),
      titolo_ (titolo, this),
      proprietario_ (proprietario, this),
      inizio_ (inizio, this),
      ambiti_ (ambiti, this)
    {
    }
    ...
    operator= (const info& x)
    {
      if (this != &x)
      {
        ...
        this->proprietario_ = x.proprietario_;
        this->inizio_ = x.inizio_;
        this->ambiti_ = x.ambiti_;
      }
    ...
    ambiti& ambiti::
    operator= (const ambiti& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->ambito_ = x.ambito_;
      }
    ...
    legenda& legenda::
    operator= (const legenda& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->testo_ = x.testo_;
        this->scioglimento_ = x.scioglimento_;
      }
    ...
    descrizioni& descrizioni::
    operator= (const descrizioni& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->descrizione_ = x.descrizione_;
        this->legenda_ = x.legenda_;
        this->fileImmagine_ = x.fileImmagine_;
      }
    ...
    misura& misura::
    operator= (const misura& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->unita_ = x.unita_;
        this->valore_ = x.valore_;
      }
    ...
    nominale& nominale::
    operator= (const nominale& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->valuta_ = x.valuta_;
        this->valore_ = x.valore_;
      }
    ...
    libro& libro::
    operator= (const libro& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->sigla_ = x.sigla_;
    ...
    : ::xml_schema::type (),
      ...
      lotto_ (lotto, this),
      stima_ (stima, this),
      aggiudicazione_ (aggiudicazione, this)
    {
    }
    ...
    asta& asta::
    operator= (const asta& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->casa_ = x.casa_;
        this->idAsta_ = x.idAsta_;
        this->data_ = x.data_;
        this->lotto_ = x.lotto_;
        this->stima_ = x.stima_;
        this->aggiudicazione_ = x.aggiudicazione_;
      }
    ...
    documentoAddizionale& documentoAddizionale::
    operator= (const documentoAddizionale& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
    ...
    documentiAggiuntivi& documentiAggiuntivi::
    operator= (const documentiAggiuntivi& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->documento_ = x.documento_;
      }
    ...
    : ::xml_schema::type (),
      contenitore_ (contenitore, this),
      vassoio_ (vassoio, this),
      riga_ (riga, this),
      colonna_ (colonna, this)
    {
    }
    ...
    posizione& posizione::
    operator= (const posizione& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->contenitore_ = x.contenitore_;
        this->vassoio_ = x.vassoio_;
        this->riga_ = x.riga_;
        this->colonna_ = x.colonna_;
      }
    ...
    datiAcquisto& datiAcquisto::
    operator= (const datiAcquisto& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->luogo_ = x.luogo_;
        this->data_ = x.data_;
        this->prezzo_ = x.prezzo_;
      }
    ...
    : ::xml_schema::type (),
      peso_ (peso, this),
      diametro_ (diametro, this),
      forma_ (forma, this),
      metallo_ (metallo, this)
    {
    }
    ...
    datiFisici& datiFisici::
    operator= (const datiFisici& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->peso_ = x.peso_;
        this->diametro_ = x.diametro_;
        this->forma_ = x.forma_;
        this->metallo_ = x.metallo_;
      }
    ...
    datiArtistici& datiArtistici::
    operator= (const datiArtistici& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->dritto_ = x.dritto_;
        this->rovescio_ = x.rovescio_;
        this->taglio_ = x.taglio_;
      }
    ...
    zecchieri& zecchieri::
    operator= (const zecchieri& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->zecchiere_ = x.zecchiere_;
      }
    ...
    stato& stato::
    operator= (const stato& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->colore_ = x.colore_;
        this->motivo_ = x.motivo_;
      }
    ...
    : ::xml_schema::type (),
      ambiti_ (this),
      paese_ (paese, this),
      autorita_ (autorita, this),
      anno_ (anno, this),
      nominale_ (nominale, this),
      zecca_ (zecca, this),
      zecchieri_ (zecchieri, this),
      datiArtistici_ (datiArtistici, this),
      datiFisici_ (datiFisici, this),
      datiAcquisto_ (datiAcquisto, this),
      posizione_ (this),
      grado_ (this),
      note_ (note, this),
      letteratura_ (letteratura, this),
      itemAddizionali_ (itemAddizionali, this),
      stato_ (stato, this),
      revisione_ (revisione, this),
      id_ (id, this)
    {
    }
    ...
    moneta& moneta::
    operator= (const moneta& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->ambiti_ = x.ambiti_;
        this->paese_ = x.paese_;
        this->autorita_ = x.autorita_;
        this->anno_ = x.anno_;
        this->nominale_ = x.nominale_;
        this->zecca_ = x.zecca_;
        this->zecchieri_ = x.zecchieri_;
        this->datiArtistici_ = x.datiArtistici_;
        this->datiFisici_ = x.datiFisici_;
        this->datiAcquisto_ = x.datiAcquisto_;
        this->posizione_ = x.posizione_;
        this->grado_ = x.grado_;
        this->note_ = x.note_;
        this->letteratura_ = x.letteratura_;
        this->itemAddizionali_ = x.itemAddizionali_;
        this->stato_ = x.stato_;
        this->revisione_ = x.revisione_;
        this->id_ = x.id_;
      }
    ...
    monete& monete::
    operator= (const monete& x)
    {
      if (this != &x)
      {
        static_cast< ::xml_schema::type& > (*this) = x;
        this->info_ = x.info_;
        this->moneta_ = x.moneta_;
      }
...
namespace gestColl
{
  namespace coins
  {
             ...
             const ::xml_schema::properties& p)
    {
      ...
      return ::std::auto_ptr< ::gestColl::coins::monete > (
    ...
    ::std::auto_ptr< ::gestColl::coins::monete >
    monete_ (const ::xercesc::DOMDocument& doc,
             ::xml_schema::flags f,
             const ::xml_schema::properties& p)
    {
