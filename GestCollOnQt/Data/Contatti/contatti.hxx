...
/**
 * @file
 * @brief Generated from contatti.xsd.
 */

#ifndef XML_SCHEMA_CONTATTI_HXX
#define XML_SCHEMA_CONTATTI_HXX
...
{
  /**
   * @brief C++ namespace for the %http://gestColl/contatti
   * schema namespace.
   */
  namespace contatti
  {
    /**
     * @brief Class corresponding to the %contatto schema type.
     *
     * Tipo che definisce un contatto
     *
     * @nosubgrouping
     */
    class contatto: public ::xml_schema::type
    {
      public:
      /**
       * @name nome
    ...
    /**
     * @brief Class corresponding to the %contatti schema type.
     *
     * @nosubgrouping
     */
    class contatti: public ::xml_schema::type
    {
      public:
      /**
       * @name contatto
       *
       * @brief Accessor and modifier functions for the %contatto
       * sequence element.
       */
      //@{
       ...
       * @brief Element type.
       */
      typedef ::gestColl::contatti::contatto contatto_type;

      /**
       * @brief Element sequence container type.
       */
      typedef ::xsd::cxx::tree::sequence< contatto_type > contatto_sequence;

      /**
       * @brief Element iterator type.
       */
      typedef contatto_sequence::iterator contatto_iterator;

      /**
       * @brief Element constant iterator type.
       */
      typedef contatto_sequence::const_iterator contatto_const_iterator;

      /**
       * @brief Element traits type.
       */
      typedef ::xsd::cxx::tree::traits< contatto_type, wchar_t > contatto_traits;
...
namespace gestColl
{
  ...
  {
    /**
     * @name Parsing functions for the %contatti document root.
     *
     * Descrizione di un elenco di contatti
     */
    //@{
    ...
    contatti_ (const ::std::wstring& uri,
               ::xml_schema::flags f = 0,
     ...
     */
    ::std::auto_ptr< ::gestColl::contatti::contatti >
    contatti_ (::xercesc::InputSource& is,
               ::xml_schema::flags f = 0,
               const ::xml_schema::properties& p = ::xml_schema::properties ());
...
namespace gestColl
{
  ...
  {
    void
    operator<< (::xercesc::DOMElement&, const contatto&);

    /**
     * @name Serialization functions for the %contatti document root.
     *
     * Descrizione di un elenco di contatti
     */
    //@{
     ...
     */
    void
    contatti_ (::std::ostream& os,
               const ::gestColl::contatti::contatti& x, 
     ...
     */
    void
    contatti_ (::xercesc::XMLFormatTarget& ft,
               const ::gestColl::contatti::contatti& x, 
               const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
               const ::std::wstring& e = L"UTF-8",
               ::xml_schema::flags f = 0);
    ...
    contatti_ (const ::gestColl::contatti::contatti& x, 
               const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
               ::xml_schema::flags f = 0);
    ...
    void
    operator<< (::xercesc::DOMElement&, const contatti&);
  }
}
